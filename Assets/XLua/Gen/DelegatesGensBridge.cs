...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp2(int p0, out int p1, out bool p2, out string p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp3(int p0, ref int p1, ref bool p2, ref string p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp15(int p0, string p1, out Tutorial.CSCallLua.DClass p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public XLuaTest.InvokeLua.ICalc __Gen_Delegate_Imp17(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp18(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp34(object p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Collections.IEnumerator __Gen_Delegate_Imp35(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new UnityEngine.Events.UnityAction<float>(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(CustomCall2))
			{
			    return new CustomCall2(__Gen_Delegate_Imp1);
			}
			...
			{
			    return new CustomCall3(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(CustomCall4))
			{
			    return new CustomCall4(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(CustomCall5))
			{
			    return new CustomCall5(__Gen_Delegate_Imp4);
			}
			...
			{
			    return new System.Func<double, double, double>(__Gen_Delegate_Imp6);
			}
			...
			{
			    return new System.Action<double>(__Gen_Delegate_Imp8);
			}
			...
			{
			    return new Tutorial.CSCallLua.FDelegate(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(Tutorial.CSCallLua.GetE))
			{
			    return new Tutorial.CSCallLua.GetE(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(XLuaTest.InvokeLua.CalcNew))
			{
			    return new XLuaTest.InvokeLua.CalcNew(__Gen_Delegate_Imp17);
			}
